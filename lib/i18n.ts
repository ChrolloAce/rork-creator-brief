...
const en = {
  ...
  stepGenerateSub: "One tap. Video plus caption.",
  lockedWord: "Locked",
  ...
  todaysVideos: "Today's videos",
  earlierVideos: "Earlier videos",
  nothingToday: "Nothing yet today. Tap Generate.",
...
const es: Record<UIKey, string> = {
  ...
  stepGenerateSub: "Un toque. Video y caption.",
  ...
  todaysVideos: "Videos de hoy",
  earlierVideos: "Videos anteriores",
  nothingToday: "Nada todavía hoy. Toca Generar.",
