...
const en = {
  ...
  stepUpload: "Upload your demos",
  stepUploadSub: "Short clips of you using the product. Phone or screen recording.",
  stepPick: "Tap Generate",
  stepPickSub: "We pick a hook, one of your demos and a background clip.",
  stepBuild: "Download and post",
  stepBuildSub: "Every video comes with its caption. Tap again for a new mix.",
...
const es: Record<UIKey, string> = {
  ...
  stepUpload: "Sube tus demos",
  stepUploadSub: "Clips cortos usando el producto. Teléfono o grabación de pantalla.",
  stepPick: "Toca Generar",
  stepPickSub: "Elegimos un hook, uno de tus demos y un clip de fondo.",
  stepBuild: "Descarga y publica",
  stepBuildSub: "Cada video viene con su caption. Toca de nuevo para otra mezcla.",
